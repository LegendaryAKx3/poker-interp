...
def run_probing(ckpt_dir: str, tokenizer_dir: str, data_dir: str, max_samples: int = 300000):
    ...
    for layer_idx, (h_train, h_test) in enumerate(zip(hidden_train, hidden_test)):
        ...
        plt.tight_layout()
        plt.savefig(f"confusion_matrices/handRankSelect/confusion_matrix_layer_{layer_idx:02d}.png", dpi=300)
        plt.close()

    print("Probing complete. Confusion matrices saved in 'confusion_matrices/handRankSelect/'.")
