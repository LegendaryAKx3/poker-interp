...
def plot_confusion_matrix(cm, layer_idx, save_dir="confusion_matrices/actionIdentification/"):
...
def run_probing(ckpt_dir: str, tokenizer_dir: str, data_dir: str, max_samples: int = 10000):
    ...
    print("Probing complete. Confusion matrices saved in 'confusion_matrices/'.")
